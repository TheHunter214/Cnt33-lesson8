...
class TMNProductAddOrEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id:  1,
        ...
        return (
            <div>
                ...
                <form className='col-md-6'>
                    ...
                    <button onClick={this.tmnhandleSubmit} className='btn btn-success'>{elementbutton}</button>
                </form>
            </div>
        )
    }
